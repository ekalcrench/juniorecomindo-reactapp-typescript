...
function Home() {
  ...
  const [countList, setCountList] = useState<number | null>();
  ...
  useEffect(
    () => {
      axios
        ...
        .then((res) => {
          console.log("GET componentDidMount : ", res);
          setList(res.data);
          setCountList(res.data.length);
    ...
    <div>
      ...
      <div className={classes.container}>
        <Box className={classes.box}>
          {/* Jika masih loading dan belum ada listnya */}
          {loading && list
            ? list?.map((promo) => {
                return (
